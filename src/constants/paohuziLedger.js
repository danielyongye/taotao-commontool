...
export const STORAGE_KEY = 'PAOHUZI_LEDGER_SESSIONS'
...
export const EDIT_PAGE = '/pages/paohuziLedger/edit/index'
export const INDEX_PAGE = '/pages/paohuziLedger/index'
